Feature: CreateMember
  ...
  Given I navigate to page "http://localhost:2368/ghost/"
    ...
    And I wait for 5 seconds
    And I Fill Name of the Member "Rose Carlino"
    And I wait for 3 seconds
    And I Fill Email of the Member "rcarlino1c@simplemachines.org"
    And I wait for 3 seconds
    And I Fill Note of the Member "Integer ac leo."  
    And I wait for 3 seconds
