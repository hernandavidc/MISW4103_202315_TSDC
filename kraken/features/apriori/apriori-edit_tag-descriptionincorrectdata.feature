...
Given I navigate to page "http://localhost:2368/ghost/"
  ...
  And I wait for 3 seconds 
  And I enter Name Tag "Kassi"
  And I wait for 2 seconds
  And I enter Color Tag "b3e6a0"
  And I wait for 2 seconds
  And I enter Description Tag "Nulla nisl. Nunc nisl. Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa. Donec dapibus. Duis at velit eu est congue elementum. In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo. Aliquam quis turpis eget elit sodales scelerisque."  
  And I wait for 2 seconds
