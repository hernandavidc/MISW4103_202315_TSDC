...
When('I enter a title {string}', async function (title) {
    let element = await this.driver.$('[class="gh-editor-title ember-text-area gh-input ember-view"]');
...
When('I publish the Page', async function () {
    let element = await this.driver.$('*[data-ebd-id="ember22-trigger"]');
    return await element.click();
});
...
When('I click Options Post', async function() {
    let element = await this.driver.$('*[class="ember-view permalink gh-list-data gh-post-list-featured"]');    
    return await element.click();
});
//DELETE POST
When('I click Delete Post', async function() {
    let element = await this.driver.$('*[class="gh-btn gh-btn-hover-red gh-btn-icon settings-menu-delete-button" type="button"]');
    return await element.click();
});
...
When('I click Back', async function() {
    let element = await this.driver.$('[class="gh-koenig-editor-pane flex flex-column mih-100"]');
    return await element.click();
})

When('I click Options New Post', async function() {
    let element = await this.driver.$('*[class="post-settings"]');
    return await element.click();
})
